...
class ContextMenu extends HTMLElement {
    ...
    extension() {
        windowManager.openWindow("/sysc/scripts/components/form/mat-editor/dialog/extended-dialog", {
            data: {
                path: this.path
            }
        })
    ...
    static get template() {
        return loader("sysc/scripts/components/form/mat-editor/context-menu.html")
    }
